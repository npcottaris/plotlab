...
<tr>
 <td> <img src="assets/demoPlots/mRGCsf-light.png" width="420" /> </td>
 <td> <img src="assets/demoPlots/SSnomograms-light.png" width="400" /> </td>
 <tr>
 <td> <pre> t_areaPloUsingInternalRecipe.m </pre> </td>
 <td> <pre> t_histogramPlotUsingExternalRecipe.m </pre> </td>
  <tr>
 <td> <img src="assets/demoPlots/RFProfile-light.png" width="400" /> </td>
 <td> <img src="assets/demoPlots/PSTHhistogram-light.png" width="400" /> </td>
 <tr>
 <td> <pre> t_contourPlot.m </pre> </td>
 <td> <pre> t_contourPlot.m (dark theme) </pre> </td>
 <tr>
 <td> <img src="assets/demoPlots/PointSpreadFunction-light.png" width="400" /> </td>
 <td> <img src="assets/demoPlots/PointSpreadFunction-dark.png" width="400" /> </td>
 <tr>
 <td> <pre> t_surfacePlotUsingExternalRecipe.m </pre> </td>
 <td> <pre> t_surfacePlotUsingExternalRecipe.m (dark theme) </pre> </td>
 <tr>
 <td> <img src="assets/demoPlots/xtRF-light.png" width="400" /> </td>
 <td> <img src="assets/demoPlots/xtRF-dark.png" width="400" /> </td>
</table>
